import { deepClone } from '../src/lib/other/deepClone';
import { isPrimitive } from '../src/lib/types';
...
test('isPrimitive', () => {
	...
	expect(isPrimitive(420)).toBe(true);
	expect(isPrimitive(BigInt(420))).toBe(true);
